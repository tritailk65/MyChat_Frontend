...
import com.example.testandroid.databinding.FirebaseCallBinding;
import com.example.testandroid.repositories.FirebaseRepository;
import com.example.testandroid.util.DataModelType;

public class FirebaseCallActivity extends AppCompatActivity implements FirebaseRepository.Listener {
    private FirebaseCallBinding views;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        views = FirebaseCallBinding.inflate(getLayoutInflater());
