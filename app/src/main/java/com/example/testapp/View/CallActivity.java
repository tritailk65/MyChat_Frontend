...
import com.example.testapp.databinding.FindCallActivityBinding;
import com.example.testapp.repository.MainRepo;
import com.example.testapp.utils.DataModelType;

public class CallActivity extends AppCompatActivity implements MainRepo.Listener {
    private FindCallActivityBinding views;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        views = FindCallActivityBinding.inflate(getLayoutInflater());
