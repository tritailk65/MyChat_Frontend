package com.example.easychat.webrtc;

import android.content.Context;

import com.example.easychat.model.CallModel;
import com.example.easychat.model.CallTypeModel;
...
public class WebRTCClient {
                        ...
                        public void onSetSuccess() {
                            ...
                            if (listener!=null){
                                listener.onTransferDataToOtherPeer(new CallModel(
                                        target,username,sessionDescription.description, CallTypeModel.Offer
                                ));
                            }
                        }
                    },sessionDescription);
                ...
                public void onCreateSuccess(SessionDescription sessionDescription) {
                    ...
                    peerConnection.setLocalDescription(new MySdpObserver(){
                        ...
                        public void onSetSuccess() {
                            ...
                            if (listener!=null){
                                listener.onTransferDataToOtherPeer(new CallModel(
                                        target,username,sessionDescription.description, CallTypeModel.Answer
                                ));
                            }
                        }
                    },sessionDescription);
    ...
    public void sendIceCandidate(IceCandidate iceCandidate, String target){
        ...
        if (listener!=null){
            listener.onTransferDataToOtherPeer(new CallModel(
                    target,username,gson.toJson(iceCandidate),CallTypeModel.IceCandidate
            ));
        }
    }
